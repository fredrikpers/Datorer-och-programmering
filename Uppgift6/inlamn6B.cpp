...
int main()
{
    ...
    std::ifstream     is("/Users/fredrikpettersson/CLionProjects/Datorer-och-programmering/Uppgift6/resa.txt");
    ...
    std::ofstream os("/Users/fredrikpettersson/CLionProjects/Datorer-och-programmering/Uppgift6/transaktioner.txt");
...
void PersonLista::laggTill(Person ny_person) {
    ...
    Person *tempPerson = personer; // Skapa temporär variabel och kopiera över personer till den
    personer = new Person[antal_personer + 1]; // Skapa ny personer som är en längre

    for(int i = 0; i < antal_personer; i++)
        personer[i] = tempPerson[i]; // Kopiera över den gamla personer till den nya

    personer[antal_personer] = ny_person; //Lägg till den nya personen lägst bak
    antal_personer++; // Plussa på antal personer med ett
}
...
void TransaktionsLista::laggTill(Transaktion &t) {
    ...
    Transaktion *tempTrans = transaktioner;
    transaktioner = new Transaktion[antal_transaktioner + 1];

    for(int i = 0; i < antal_transaktioner; i++)
        transaktioner[i] = tempTrans[i];
